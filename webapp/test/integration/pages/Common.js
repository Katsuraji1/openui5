sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskErahovets/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskErahovets.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskErahovets/localService/mockserver"], function (mockserver) {
